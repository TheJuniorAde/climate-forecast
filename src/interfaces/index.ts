...
export interface UseWheaterForecastResult {
  loading: boolean
  ...
  loadLocation: (mustSetLoading?: boolean) => void
}

export type WheaterForecastContextResult = UseWheaterForecastResult & {
  isWaiting: boolean
  isLoading: boolean
  mustShowData: boolean
}
